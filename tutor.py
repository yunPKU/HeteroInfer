...
""" 
simuG = HI.singleSimu(mu_InFC = 1,mu_Rec = 1/2.5);
inferRe 	= HI.singleEst(simuG, back_ratio = [0.9,0.85,0.8], smpRatio = 0.9)


""" multiple simulaiton and analysis
"""
res = HI.cmpEst(mu_InFC = 1,mu_Rec = 1/2.5,simu_K = 2)
HI.EstRePlot(re)
